...
ActiveRecord::Schema.define(:version => 20120312110705) do

  create_table "blogel_categories", :force => true do |t|
    t.string   "name"
    t.string   "slug"
    t.integer  "parent_id"
    t.text     "description"
  ...
  create_table "blogel_categories_posts", :id => false, :force => true do |t|
    t.integer "category_id"
    t.integer "post_id"
  end

  create_table "blogel_comments", :force => true do |t|
    t.string   "title"
    t.text     "content"
    t.integer  "post_id"
    t.integer  "user_id"
  ...
  create_table "blogel_posts", :force => true do |t|
    t.string   "title"
    t.string   "slug"
    t.text     "content"
  ...
  create_table "blogel_posts_tags", :id => false, :force => true do |t|
    t.integer "post_id"
    t.integer "tag_id"
  end

  create_table "blogel_tags", :force => true do |t|
    t.string   "name"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end
